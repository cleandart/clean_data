...
void main() {
  ...
  group('(FilteredCollectionView)', () {
    ...
    test('change Filter. (T03)', () {
      // given
      FilteredCollectionView evenLongMonths = months.liveWhere((month) => month['number'] % 2 == 0);
    ...
    test('change args of filter. (T04)', () {
      ...
      FilteredCollectionView everyKthMonth = months.liveWhere((month, key) => month['number'] % key.value == 0, k);
